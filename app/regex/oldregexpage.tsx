    ...
    return (
        <>
            <div className='m-8 text-[40px] font-bold'>
                ...
                <div className='font-normal mt-3 text-red'>
                    {myjson["github"]}
                </div>
                <div>
                    <div
